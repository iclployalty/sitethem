...
DROP TABLE IF EXISTS `wp_mailster_forms`;
...
LOCK TABLES `wp_mailster_forms` WRITE;
/*!40000 ALTER TABLE `wp_mailster_forms` DISABLE KEYS */;
INSERT INTO `wp_mailster_forms` VALUES (1,'Newsletter Signup Footer','Subscribe',0,0,0,0,0,1,1,1,'{\".submit-button\":{\"color\":\"#ffffff\"}}','.mailster-form-1 .mailster-submit-wrapper .submit-button{\r\n    background: #d1252e;\r\n}\r\n',1,'Please confirm','Please confirm your Email Address','You have to confirm your email address. Please click the link below to confirm. \r\n{link}','Click here to confirm',1,2,48,'notification.html',0,'BEGIN:VCARD\r\nN:Firstname;Lastname;;;\r\nADR;INTL;PARCEL;WORK:;;StreetName;City;State;123456;Country\r\nEMAIL;INTERNET:lance.spurgeon@gmail.com\r\nORG:CompareWeb\r\nURL;WORK:http://prod1.compareweb.hosting\r\nEND:VCARD\r\n','','',1529768079,1529768079),(2,'Profile','Subscribe',1,1,0,0,1,0,1,1,'','',1,'Please confirm','Please confirm your Email Address','You have to confirm your email address. Please click the link below to confirm. \r\n{link}','Click here to confirm',1,2,48,'notification.html',0,'BEGIN:VCARD\r\nN:Firstname;Lastname;;;\r\nADR;INTL;PARCEL;WORK:;;StreetName;City;State;123456;Country\r\nEMAIL;INTERNET:lance.spurgeon@gmail.com\r\nORG:CompareWeb\r\nURL;WORK:http://prod1.compareweb.hosting\r\nEND:VCARD\r\n','','',1529768079,1529768079);
/*!40000 ALTER TABLE `wp_mailster_forms` ENABLE KEYS */;
UNLOCK TABLES;
