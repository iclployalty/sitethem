...
DROP TABLE IF EXISTS `wp_mdf_stat_tmp`;
...
LOCK TABLES `wp_mdf_stat_tmp` WRITE;
/*!40000 ALTER TABLE `wp_mdf_stat_tmp` DISABLE KEYS */;
/*!40000 ALTER TABLE `wp_mdf_stat_tmp` ENABLE KEYS */;
UNLOCK TABLES;
